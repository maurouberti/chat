...
gulp.task('build', gulp.series(['build-html', 'build-css', 'build-js', 'build-images', 'build-fonts'], function() {
    return initServer()
}));
...
gulp.task('watch', () => {
    ...
    gulp.watch(paths.imgSrc.concat('**/*.+(png|jpeg|jpg|svg)'), ['build-images']);
})
